...
static const unsigned int gappoh_uw = 100;      /* horiz outer gap between windows and screen edge (my custom "ultrawide monitor mode") */
static const unsigned int gappov_uw = 850;      /* vert outer gap between windows and screen edge (my custom "ultrawide monitor mode") */
static const int smartgaps          = 0;        /* 1 means no outer gap when there is only one window */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "JuliaMono:size=13" };
static const char dmenufont[]       = "JuliaMono:size=13";
